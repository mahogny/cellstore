...
package cellstore.hdf.object.nc2;
...
//            log.debug("raf close:", ex);
     ...
     */
    @Override
    public void writeAttribute(HObject obj, cellstore.hdf.object.Attribute attr,
    ...
    public static cellstore.hdf.object.Attribute convertAttribute(
            ucar.nc2.Attribute netcdfAttr) {
        cellstore.hdf.object.Attribute ncsaAttr = null;
        ...
        ncsaAttr = new cellstore.hdf.object.Attribute(attrName, attrType, attrDims);
